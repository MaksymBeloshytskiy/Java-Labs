...
class XmlFileWriterTest {
    ...
    private static final String TEST_FILE = "test_conferences.xml";
    ...
    void testWriteData() {
        ...
        XmlFileWriter.writeData(conferences, TEST_FILE);
        ...
        // Verify that the XML content contains conference names and places
